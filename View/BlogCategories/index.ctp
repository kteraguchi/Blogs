			...
			<tr>
				...
				<td>
					<?php echo $this->Html->link(
						$blogCategory['Block']['name'],
						array('controller' => 'blocks', 'action' => 'view', $blogCategory['Block']['id'])
					); ?>
				</td>
				...
				<td class="actions">
					<?php echo $this->Html->link(
						__('View'),
						array('action' => 'view', $blogCategory['BlogCategory']['id'])
					); ?>
					<?php echo $this->Html->link(
						__('Edit'),
						array('action' => 'edit', $blogCategory['BlogCategory']['id'])
					); ?>
					<?php echo $this->Form->postLink(
						__('Delete'),
						array('action' => 'delete', $blogCategory['BlogCategory']['id']),
						null,
						__('Are you sure you want to delete # %s?', $blogCategory['BlogCategory']['id'])
					); ?>
				</td>
			</tr>
		<?php endforeach; ?>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(
				__('List Blog Entries'),
				array('controller' => 'blog_entries', 'action' => 'index')
			); ?> </li>
		<li><?php echo $this->Html->link(
				__('New Blog Entry'),
				array('controller' => 'blog_entries', 'action' => 'add')
			); ?> </li>
	</ul>
</div>
