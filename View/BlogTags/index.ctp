<div class="blogTags index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($blogTag['Block']['name'], array('controller' => 'blocks', 'action' => 'view', $blogTag['Block']['id'])); ?>
		</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $blogTag['BlogTag']['id']), null, __('Are you sure you want to delete # %s?', $blogTag['BlogTag']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
