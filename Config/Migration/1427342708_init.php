	...
	public $migration = array(
		'up' => array(
			'create_table' => array(
				...
				'blog_category_orders' => array(
					'id' => array('type' => 'integer', 'null' => false, 'default' => null, 'key' => 'primary', 'comment' => 'ID |  |  | '),
					'blog_category_key' => array('type' => 'string', 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'category key | カテゴリーKey | blog_categories.key | ', 'charset' => 'utf8'),
		...
		'down' => array(
			'drop_table' => array(
				'blog_block_settings', 'blog_categories', 'blog_category_orders', 'blog_entries', 'blog_entry_tag_links', 'blog_frame_settings', 'blog_tags'
			),
		),
	);
